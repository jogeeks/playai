...
import { ArrowLeft, Sparkles, Eye, Flame, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen overflow-y-auto overflow-x-hidden bg-gradient-to-b from-[#1a0f0a] via-[#2a1a10] to-[#1a0f0a] text-[#ffddaa] font-cinzel">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <motion.header {...fadeIn} className="text-center mb-12 sm:mb-16">
        ...
        <div className="space-y-12 sm:space-y-16">
          <motion.section 
            ...
            className="bg-gradient-to-r from-[#3e2723]/50 to-transparent p-6 sm:p-8 rounded-lg border-l-4 border-[#ffaa55]"
            data-testid="section-dispenser"
          >
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              <div className="p-3 sm:p-4 bg-[#ffaa55]/20 rounded-full shrink-0">
          ...
          <motion.section 
            ...
            className="bg-gradient-to-l from-[#004d5e]/30 to-transparent p-6 sm:p-8 rounded-lg border-r-4 border-cyan-400"
            data-testid="section-oracle"
          >
            <div className="flex flex-col sm:flex-row-reverse items-start gap-4 sm:gap-6">
              <div className="p-3 sm:p-4 bg-cyan-400/20 rounded-full shrink-0">
              ...
              <div className="sm:text-right">
                ...
                <div className="space-y-4 font-rajdhani text-base sm:text-lg leading-relaxed text-left">
                  <p>
          ...
          <motion.section 
            ...
            className="bg-gradient-to-r from-[#5d1a1a]/30 to-transparent p-6 sm:p-8 rounded-lg border-l-4 border-orange-500"
            data-testid="section-temple"
          >
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              <div className="p-3 sm:p-4 bg-orange-500/20 rounded-full shrink-0">
        ...
        <motion.footer 
          ...
          className="mt-16 sm:mt-20 text-center border-t border-[#ffaa55]/20 pt-10 sm:pt-12 pb-8"
        >
